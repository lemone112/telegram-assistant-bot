...
- [x] Create a Linear **Project** (name rule: `Company — Deal name`).
- [x] Persist mapping in `bot.deal_linear_links` (Attio deal → Linear project).
- [x] Create the 12 kickoff issues **inside the project**.
- [x] Backlink to Attio (NOTE is preferred as the default).
